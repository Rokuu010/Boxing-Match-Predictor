...
# I'm defining a single directory to store all my trained model files.
MODELS_DIR = "models"
...
# The .pkl extension is for saving Python objects using joblib
MODEL_PATH = os.path.join(MODELS_DIR, "fight_predictor_ensemble.pkl")
IMPUTER_PATH = os.path.join(MODELS_DIR, "imputer.pkl")

# I also save the individual tuned models. I do this so that I can load them later
